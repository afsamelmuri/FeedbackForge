...
<title>REC HULKOTI-FEEDBACK</title>
  ...
  <body>
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
          ...
          <div class="navbar-header">
            ...
            <a class="white"  href="#"><div><img src="images/REC.jpg" width="50" height="40" style="vertical-align:middle;">REC-ONLINE FEEDBACK SYSTEM</div></a>
          </div>
...
<br/>
<select class="form-control" name="SEMESTER" id="semester"  placeholder="Semeter" required="">
...
<br/>
	...
	<footer style="bottom:0; position:fixed; width:100%; height:50px; padding:0;">
         <div class="container">
          ...
          <p class="white">Copyright © 2018 REC Hulkoti. All Rights Reserved.</p>
      </div>
         </div>
      </footer>
	  <!-- Footer Ends -->
