     ...
     <header id="main-header">
      <nav class="navbar navbar-default navbar-fixed-top">
          ...
          <div class="navbar-header">
            ...
            <a class="white" href="#"><div><img src="" width="50" height="40" style="vertical-align:middle;">FEEDBACK SYSTEM ADMIN PANEL</div></a>
          </div>
	...
	<div class="page-content container">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				...
				<h3>
<a href="#">ADMIN LOGIN</a></h3>
			        <div class="box">
			            <div class="content-wrap">
			                
<input class="form-control" name="username" id="username" value="" type="text" placeholder="User Name" required>
<br/>
<input class="form-control" name="pass" id="password" type="password" value="" placeholder="Password" required>

			                	<div class="action">
<button type="submit" name="btn-login" class="btn btn-primary signup" href="index.html">Login</button>
			                </div>                
			            </div>
			        </div>
			    </div>
