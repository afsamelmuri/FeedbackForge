...
<br/>
<br/>
<table class="table-responsive"  border="1" align="center"  style="margin-left:10px; padding:20px;" >
  <tr>
...
?>
     ...
     <td style="background-color:#FF9966">&nbsp;</td>
            ...
            <tr>
              <td colspan="5" align="center">Note: Enter Rating from 1 to 5.</td>
            </tr>
            <tr>
                  ...
                  <table  id="rounded-corner" cellpadding="10" cellspacing="0" border="0" align="center" class="table table-striped">
                    <thead class="thead-dark">
                      <tr >
                        ...
                        <th class="rounded-q4">Lowest:1  and Highest:5</th>
                      </tr>
                    </thead>
                    <?php
		  	$sql_que="select * from feedback_ques_master";
			$res_que=mysqli_query($connect,$sql_que) or die(mysqli_error());
			$i=1;
			$tab_ind=7;
			$edit=0;
			while($row_que=mysqli_fetch_array($res_que))
			{
				...
				echo "<td><input type='range' min='1' max='5' value='1' class='slider' id='myRange_$i' name=\"ans_$i\" tabindex=\"$tab_ind\" >
  Value: <span id='demo_$i' style='font-size:12px;' ></span></td>";
				echo "</tr>";
				?>
                <script>
